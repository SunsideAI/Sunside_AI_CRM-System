...
function EmailComposer({ lead, user, onClose, onSent, inline = false, kategorie = null }) {
  ...
  if (success) {
    return (
      <div className={inline ? "text-center py-8" : "fixed inset-0 z-50 flex items-center justify-center p-4"}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="modal-content relative max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between pb-6">
          <div className="flex items-center">
            <div className="w-10 h-10 bg-primary-fixed rounded-lg flex items-center justify-center mr-3">
