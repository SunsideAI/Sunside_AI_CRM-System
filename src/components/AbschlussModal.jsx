...
export default function AbschlussModal({ lead, isOpen, onClose, onSubmit, isLoading }) {
  ...
  useEffect(() => {
    if (lead && isOpen) {
      setForm({
        ...
        rechnung_email: lead.rechnung_email || lead.mail || '',
    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between z-10">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Lead abschließen — Rechnungsdaten erfassen</h2>
            <p className="text-sm text-gray-500 mt-1">
              Diese Daten werden für die automatische Rechnungserstellung benötigt.
            </p>
          </div>
