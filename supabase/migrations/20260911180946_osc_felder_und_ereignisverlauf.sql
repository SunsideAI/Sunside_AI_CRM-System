...
-- OSC-Umbau, Schritt 1: neue Felder und der Ereignis-Verlauf (rein additiv).
...
-- Berechnet, nicht eingegeben. Null, sobald eine der Zahlen fehlt -
...
-- Ereignis-Verlauf: Grundlage aller Kennzahlen und Provisionsausloeser.
